...
template<>
InputParameters validParams<PolyRadiationDefectCreation>()
{
...
PolyRadiationDefectCreation::PolyRadiationDefectCreation(const InputParameters & parameters) :
    Material(parameters),
...
void
PolyRadiationDefectCreation::timestepSetup()
{
...
void
PolyRadiationDefectCreation::computeQpProperties()
{
  Real QPVacIncr = 0.0;
  Real QPIntIncr = 0.0;
  Real SumEtaj = 0.0;
